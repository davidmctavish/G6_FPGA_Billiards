...
begin
    ...
    SET_OV7670 + 0 	: 	LUT_DATA	= 	16'h1204;  // Register COM7;  0001/0000 (Output QVGA/VGA), 0100 (Output RGB) // CHANGED to VGA from QVGA
    	...
    	SET_OV7670 + 13 : 	LUT_DATA	= 	16'h3e00;   // was originaly 00
    	SET_OV7670 + 14 : 	LUT_DATA	= 	16'h7000;	
    	SET_OV7670 + 15 : 	LUT_DATA	= 	16'h7100;
    	SET_OV7670 + 16 : 	LUT_DATA	= 	16'h7200;	 // was originaly 11       
