...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { button_down }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { button_down }]; #IO_L12P_T1_MRCC_14 Sch=btnl
...
create_clock -add -name pix_clk_pin -period 40.00 -waveform {0 20} [get_ports {OV7670_PCLK}];
