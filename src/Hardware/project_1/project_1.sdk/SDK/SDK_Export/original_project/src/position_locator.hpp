...
// Current precision in the physics module is 7 bits
#define POSLOC_shiftRequired	(SHIFT - POSLOC_fractionalBits)
...
#define POSLOC_tableTop_X	(0  * NORMAL)
#define POSLOC_tableTop_Y	(0  * NORMAL)
#define POSLOC_tableBot_X	(620 * NORMAL)
...
#define POSLOC_tableScale_X	( ( 640*NORMAL << POSLOC_shiftRequired) / (POSLOC_tableBot_X - POSLOC_tableTop_X) )
#define POSLOC_tableScale_Y	( ( 480*NORMAL << POSLOC_shiftRequired) / (POSLOC_tableBot_Y - POSLOC_tableTop_Y) )
